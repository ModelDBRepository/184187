'''
Current clamp demo using Allen Brain's model 472363762.
...
from neuron472363762 import Neuron472363762
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron472363762(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 472363762; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-92.4991149902)
        h.fcurrent()
